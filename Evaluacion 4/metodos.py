...
def main():
    ...
    texto = "Asignación óptima de profesores a cursos:"
    for i in range(len(row_ind)):
        texto += f"El profesor {headers[col_ind[i]]} dictará el curso {indices[row_ind[i]]}\n"
    texto += f"Total de las preferencias maximizadas: {total_preferencias}"
